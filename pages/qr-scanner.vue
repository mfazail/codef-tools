...
<template>
	<div class="w-full max-w-4xl mx-auto">
		...
		<div class="mt-5 flex flex-col justify-center items-center w-full">
			...
			<Dialog :show="decoded" :title="result" :url="result" @closed="decoded = false" />

			<div v-show="scanning" id="reader" class="aspect-[9/16] min-w-[300px] min-h-[400px] rounded-md"></div>
			<div v-show="!scanning"
